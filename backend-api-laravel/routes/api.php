...
//
Route::group(['prefix' => 'card_punch','middleware' => ['auth.jwt']], function () {
    Route::get('/card-punch', ['uses' => 'CardPunch\CardPunchController@index']);
    Route::post('/card-punch', ['uses' => 'CardPunch\CardPunchController@store']);
    
    Route::get('/punch-types', ['uses' => 'CardPunch\PunchTypesController@index']);
});

//companies/branch_office
Route::group(['prefix' => 'companies','middleware' => ['auth.jwt']], function () {    
    Route::get('/branch_office', ['uses' => 'Companies\BranchOfficesController@index']);
});
