  ...
  computed: {
    fieldsInfo () {
      return [
        ...
        {
          type: 'input',
          column: 'correspondence_pronvince',
          text: this.$t('fields.correspondenceProvince'),
          grid: 'xs12 sm6 md4 lg6 xl4',
          table: false,
          create: false,
          multiedit: false,
